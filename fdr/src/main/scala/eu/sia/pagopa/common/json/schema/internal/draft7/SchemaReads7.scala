package eu.sia.pagopa.common.json.schema.internal.draft7
...
import eu.sia.pagopa.common.json.schema.internal.draft7.constraints._
import eu.sia.pagopa.common.json.schema.internal.serialization.SchemaReads
import eu.sia.pagopa.common.json.schema.{ SchemaVersion, _ }
...
trait SchemaReads7 extends SchemaReads { self: SchemaVersion =>
  ...
  override lazy val arrayKeywords: Set[String] =
    Set(Keywords.Array.AdditionalItems, Keywords.Array.Items, Keywords.Array.MaxItems, Keywords.Array.MinItems, Keywords.Array.UniqueItems, "contains") ++ anyKeywords
  ...
  override lazy val arrayReads: Reads[SchemaArray] = {
    (
      ...
      val constraints = ArrayConstraints7(maxItems, minItems, additionalItems, contains, uniqueItems, any)
  ...
  lazy val objectConstraintReads: Reads[ObjectConstraints] = {
    (
      ...
      val schema =
        ObjectConstraints7(additionalProperties, dependencies, patternProperties, required, minProperties, maxProperties, propertyNames, anyConstraints)
