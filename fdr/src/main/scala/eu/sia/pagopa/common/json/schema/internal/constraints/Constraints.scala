package eu.sia.pagopa.common.json.schema.internal.constraints
...
object Constraints {
  ...
  case class NoConstraints() extends Constraint {
    ...
    override def validate(schema: SchemaType, json: JsValue, context: SchemaResolutionContext)(implicit lang: Lang): VA[JsValue] = Success(json)
