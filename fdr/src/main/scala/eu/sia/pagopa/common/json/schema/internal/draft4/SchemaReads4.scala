package eu.sia.pagopa.common.json.schema.internal.draft4
...
import eu.sia.pagopa.common.json.schema.internal.draft4.constraints._
import eu.sia.pagopa.common.json.schema.internal.serialization.SchemaReads
import eu.sia.pagopa.common.json.schema.{ SchemaArray, SchemaInteger, SchemaNumber, SchemaObject, SchemaProp, SchemaString, SchemaTuple, SchemaType, SchemaVersion }
...
trait SchemaReads4 extends SchemaReads { self: SchemaVersion =>
  ...
  lazy val anyKeywords =
    Set(Keywords.Any.AllOf, Keywords.Any.AnyOf, Keywords.Any.OneOf, Keywords.Any.Not, Keywords.Default, Keywords.Any.Definitions, Keywords.Any.Description, Keywords.Any.Enum, Keywords.Any.Type, "id")
  ...
  override lazy val arrayKeywords: Set[String] =
    Set(Keywords.Array.AdditionalItems, Keywords.Array.Items, Keywords.Array.MaxItems, Keywords.Array.MinItems, Keywords.Array.UniqueItems) ++ anyKeywords
  ...
  override lazy val arrayReads: Reads[SchemaArray] = {
    (
      ...
      val constraints = ArrayConstraints4(maxItems, minItems, additionalItems, uniqueItems, any)
  ...
  lazy val objectConstraintReads: Reads[ObjectConstraints] = {
    (
      ...
      Reads.pure(ObjectConstraints4(additionalProperties, dependencies, patternProperties, required, minProperties, maxProperties, anyConstraints))
    }
  }
