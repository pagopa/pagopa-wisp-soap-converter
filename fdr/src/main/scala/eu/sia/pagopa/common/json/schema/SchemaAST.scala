...
final case class SchemaTuple(items: Seq[SchemaType], constraints: ArrayConstraints, otherProps: Seq[(String, SchemaType)] = Seq.empty) extends SchemaArrayLike with HasProps[SchemaTuple] {
...
final case class SchemaArray(item: SchemaType, constraints: ArrayConstraints, otherProps: Seq[(String, SchemaType)] = Seq.empty) extends SchemaArrayLike with HasProps[SchemaArray] {
