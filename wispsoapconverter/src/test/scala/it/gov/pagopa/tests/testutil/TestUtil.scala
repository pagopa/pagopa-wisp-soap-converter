...
object TestItems {
  ...
  val stazione_NO_INT = "stazioneTest_noint"
  val stazione_DISABLED = "stazioneTest_dis"
  val stazione_INT_DISABLED = "stazioneTest_int_dis"
  ...
  val PSP = "pspTest"
  val PSP_NO_BOLLO = "pspTest_nobollo"
  ...
  val canaleImmediatoNoPlugin = "canaleImmediatoNoPlugin"
